<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DfltAdminCarrusel.aspx.cs" Inherits="DfltAdminCarrusel" %>
        ...
        <table class="auto-style1">
            <tr>
                <td style="width: 10%; vertical-align: top;">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RLBlogConfig %>" SelectCommand="SELECT [id], [Tema] FROM [carousel] WHERE [DELETE]!=1"></asp:SqlDataSource>
...
<FileListItemStyle CssClass="pending dxucFileListItem"></FileListItemStyle>
                        ...
                        <tr>
                            <td class="auto-style4" style="width: 20%">URL:</td>
                            <td>
